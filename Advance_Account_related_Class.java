...
creat_menu.account_initialization();
            ...
            key_one_string =   JOptionPane.showInputDialog(null,"What do you want???\n1.withdraw\n2.deposit");
            if(key_one_string=="1"){
                key_one_string= JOptionPane.showInputDialog("Enter Your amount to withdraw :");
                amount = Double.parseDouble(key_one_string);

                show_info.withdraw(amount);
            }
            else if(key_one_string=="2"){
                key_one_string= JOptionPane.showInputDialog("Enter Your amount to deposit :");
                amount = Double.parseDouble(key_one_string);

                show_info.deposit(amount);
